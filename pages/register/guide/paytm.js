            ...
            <div className="GuidePage__container">
                ...
                <div className="GuidePage__steps">
                    <div className="GuidePage__step">
                        <h3>Step 1: Open Paytm</h3>
                        <p>Open the Paytm app on your device.</p>
                    </div>
                    <div className="GuidePage__step">
                        ...
                        <div className="GuidePage__image-placeholder">
                            [Insert Screenshot of Balance & History Button Here]
                        </div>
                    </div>
                    <div className="GuidePage__step">
                        <h3>Step 3: Select the Payment</h3>
                        <p>Under the "Payment History" section, find and tap on the payment made to TEDxShivNadarUniversity.</p>
                        <div className="GuidePage__image-placeholder">
                    ...
                    <div className="GuidePage__step">
                        ...
                        <div className="GuidePage__image-placeholder">
                            [Insert Screenshot showing UPI Ref No Here]
                        </div>
                    </div>
                </div>
            </div>
