...
export default function Register() {
  ...
  return (
    <>
      <div className="RegisterSection" style={{ 
        display: 'flex', 
        ...
        <p style={{
          ...
          Thank you for the overwhelming response. Registrations for TEDxShiv Nadar University are now officially closed. We look forward to seeing you at the event!
        </p>
      </div>
    </>
  );
